...
def write_feature_file(features_file_name, dataset_path, genrelist, featurelist, max_songs_per_genre, overwrite):
    ...
    if "chord_max" in featurelist:
        ch = 1
        headline += " chord transition matrix"
    if "chord_all" in featurelist:
        cha=1
        headline += " chord_all transition matrix"
    headline += " label"
    ...
    for genre in genrelist:
        ...
        for filename in os.listdir(f"{dataset_path}/{genre}"):
            ...
            if ch ==1:
                ...
                line_to_add += f" {transition_matrix}"
            if cha == 1:
            ...
            i += 1
#               -----Example----
features_file_name = "chord feature.csv"
...
my_dataset_path = "C:/Users/Dennis/PycharmProjects/ML/genres_original"
...
>>>>>>> 261bd3d9405b033871e90274c32ac7ee718b0d2d
