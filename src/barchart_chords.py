...
names = "both_matrizes first_matrix second_matrix all_features_incl_chords".split()

labels = names

datab = pd.read_csv("chords_files/chords_accuracy_files/accuracy_chords_both_matrices.csv").iloc[:, 3]
dataf = pd.read_csv("chords_files/chords_accuracy_files/accuracy_chords_first_matrix.csv").iloc[:, 3]
datas = pd.read_csv("chords_files/chords_accuracy_files/accuracy_chords_second_matrix.csv").iloc[:, 3]
dataa = pd.read_csv("chords_files/chords_accuracy_files/accuracy_all_features_incl_chords.csv").iloc[:, 3]
