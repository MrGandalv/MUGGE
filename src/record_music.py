...
from converter_module import wav_to_array_file, wav_to_array_rec, mp3_to_array, mp3_to_wav, wav_to_mp3, name_wav, \
    name_mp3


def prepro(input_file, duration, offset):
    ...
    try:
        myarray = formats.get(format_type)(input_file, duration, offset)
        return myarray
    except TypeError:
